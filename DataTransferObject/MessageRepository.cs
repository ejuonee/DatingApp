...
namespace DatingApp.Data_Transfer_Object
{
    ...
    {
        // return await _context.Groups.FirstOrDefaultAsync(c => c.Name == groupName);

        return  await _context.Groups.Include(u=>u.Connections).FirstOrDefaultAsync(x=>x.Name==groupName);
    }
