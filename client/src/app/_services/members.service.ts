...
resetUserParams(){
  ...
  getMembers(userParams : UserParams){
    ...
    .pipe(map(response=>{this.memberCache.set(Object.values(userParams).join('-'),response);
  ...
  getMember(username:string){
    ...
    const member = [...this.memberCache.values()].reduce((arr, elem)=>arr.concat(elem.result),[]).find(user=>user.username===username)
